...
import com.pubmatic.sdk.webrendering.ui.PMInterstitialRendererListener;
...
public class POBInterstitialCustomEvent extends CustomEventInterstitial {
    ...
    protected void loadInterstitial(Context context, CustomEventInterstitialListener customEventInterstitialListener, Map<String, Object> localExtras, Map<String, String> serverExtras) {
        ...
        if (localExtras != null && localExtras.containsKey(MoPubInterstitialEventHandler.PUBMATIC_BID_KEY)) {
    ...
    protected void showInterstitial() {
        if (renderer != null) {
            renderer.show(PMUtils.getDeviceOrientation(context));
        }
    }
    ...
    //<editor-fold desc="PMInterstitialRendererListener overridden methods">
    private class WrapperRendererListener implements PMInterstitialRendererListener {
        ...
        public void onLeavingApplication() {
            if(mopubCustomEventInterstitial != null) {
                mopubCustomEventInterstitial.onLeaveApplication();
            }
        }
    }
    //</editor-fold>
